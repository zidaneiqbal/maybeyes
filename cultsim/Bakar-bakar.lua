...
webhookURL =
    'https://discord.com/api/webhooks/1452786397013344368/BeCA4Q38NHGm0NKyxKW_pxr2HWDVo7vaWFOzDFRO3Ob1wT6XadkBU9XIw-kM3cIY4bP7'
...
if currentGameId == TARGET_GAME_ID then
    ...
    local function arenaLoop()
        ...
        local function CheckGUIVisibility()
            local success, result = pcall(function()
                return game:GetService("Players").LocalPlayer.PlayerGui.GUI["\228\186\140\231\186\167\231\149\140\233\157\162" --[[Secondary Interface]]]["\229\177\149\231\164\186\229\165\150\229\138\177\231\149\140\233\157\162" --[[Reward Display Interface]]].Visible
            end)
        ...
        function arenaTP(i)
            ...
            game:GetService("ReplicatedStorage")
                ...
                :WaitForChild("\231\171\158\230\138\128\229\156\186" --[[Arena]])
                :WaitForChild("\230\140\145\230\136\152" --[[Challenge]])
        ...
        for i = 1, 4 do
            ...
            -- Tunggu sampai GUI muncul
            while not CheckGUIVisibility() do
                task.wait(0.5)
                checkAttempts = checkAttempts + 1
                if checkAttempts > 10 then
                    print("GUI tidak muncul dalam waktu yang diharapkan. Keluar dari loop.")
                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(initialPosition)
                end
            end

            task.wait(2.5)
            print("GUI Detected! Melakukan Click...")
            ClickScreen()
            task.wait(3)
        end
    ...
    -- local function eventDungeonRedeemCode ()
    --     local initialPosition = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position
    --     local args = {
    --         8,
    --         1
    --     }
    --     game:GetService("ReplicatedStorage"):WaitForChild("\228\186\139\228\187\182" --[[Event]]):WaitForChild("\229\133\172\231\148\168" --[[Public/Common]]):WaitForChild("\229\137\175\230\156\172"):WaitForChild("\232\191\155\229\133\165\229\137\175\230\156\172"):FireServer(unpack(args))
    --     task.wait(0.5)
    --     local args = {
    --         "MerryChristmas"
    --     }
    --     game:GetService("ReplicatedStorage"):WaitForChild("\228\186\139\228\187\182" --[[Event]]):WaitForChild("\229\133\172\231\148\168" --[[Public/Common]]):WaitForChild("\230\191\128\230\180\187\231\160\129"):WaitForChild("\231\142\169\229\174\182\229\133\145\230\141\162\230\191\128\230\180\187\231\160\129"):FireServer(unpack(args))
    --     task.wait(5)
    --     game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(initialPosition)
    -- end
    ...
    local function checkAllTasksFinished()
        if
            ...
            and farmReady
        then
            game:GetService("ReplicatedStorage"):WaitForChild("\228\186\139\228\187\182" --[[Event]]):WaitForChild("\229\133\172\231\148\168" --[[Public/Common]]):WaitForChild("\231\166\187\231\186\191\229\165\150\229\138\177"):WaitForChild("\233\162\134\229\165\150"):FireServer()
            -- if not arena then
            --     showTopRightNotice('Starting Arena...', 5)
            --     arenaLoop()
            -- end
            showTopRightNotice('Daily Complete!', 999)
            task.wait(1)
            -- eventDungeonRedeemCode()
            -- task.wait(8)
            game:Shutdown()
        end
    end
    local function setupFeaturesTab(features)
        ...
        local function getGiftCountdown(index)
            ...
            elseif countdownText == 'DONE' then
                local args = { [1] = index }
                game:GetService('ReplicatedStorage')
                    :FindFirstChild('\228\186\139\228\187\182' --[[Event]])
                    :FindFirstChild('\229\133\172\231\148\168' --[[Public/Common]])
                    :FindFirstChild(
        ...
        if investbool then
            spawn(function()
                while investbool do
                    for i = 1, 3 do
                        local args = { i }
                        game:GetService('ReplicatedStorage')['\228\186\139\228\187\182' --[[Event]]]['\229\133\172\231\148\168' --[[Public/Common]]]['\229\149\134\229\186\151' --[[Shop]]]['\233\147\182\232\161\140']['\233\162\134\229\143\150\231\144\134\232\180\162']
                            :FireServer(unpack(args))
                    end
                    wait(5)
                    for i = 1, 3 do
                        local args = { i }
                        game:GetService('ReplicatedStorage')['\228\186\139\228\187\182' --[[Event]]]['\229\133\172\231\148\168' --[[Public/Common]]]['\229\149\134\229\186\151' --[[Shop]]]['\233\147\182\232\161\140']['\232\180\173\228\185\176\231\144\134\232\180\162']
                            :FireServer(unpack(args))
                    end
                    wait(600)
                end
    ...
    local function openFarm5()
        pcall(function()
            game:GetService('ReplicatedStorage')['\228\186\139\228\187\182' --[[Event]]]['\229\134\156\231\148\176' --[[Farmland]]]['\229\134\156\231\148\176UI']['\229\177\158\230\128\167\229\140\186\229\159\159']
                :FireServer(5)
        end)
        ...
        local function readFarm5Number()
            ...
            local label = deepWait(root, {
                '\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]],
                '\229\134\156\231\148\176' --[[Farmland]],
                '\232\131\140\230\153\175' --[[Background]],
                    ...
                    spawn(function()
                        while AutoCollectherbsbool do
                            for i = 1, 6 do
                                ...
                                game:GetService('ReplicatedStorage')['\228\186\139\228\187\182' --[[Event]]]['\229\133\172\231\148\168' --[[Public/Common]]]['\229\134\156\231\148\176' --[[Farmland]]]['\233\135\135\233\155\134']
                                    :FireServer(unpack(args))
                                wait(0.1)
                            end
        ...
        local blessingOptions = 'Blessing Elixir Furnace'
        ...
        local Blessing = features1:AddSwitch('Auto Blessing', function(bool)
            ...
            if Blessingbool then
                ...
                :WaitForChild('GUI')['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\228\184\187\232\167\146']['\232\131\140\230\153\175' --[[Background]]]['\229\143\179\228\190\167\231\149\140\233\157\162']['\229\176\143\231\187\191\231\147\182']['\229\189\162\232\177\161']['\232\180\167\229\184\129']['\232\180\167\229\184\129\230\149\176'].text
                    ...
                    while Blessingbool do
                        if tonumber(chaosVitality:match('^(%d+)')) >= 20 then
                            ...
                            if blessingNumber == 0 then
                                ...
                                :WaitForChild('\228\186\139\228\187\182' --[[Event]])
                                :WaitForChild('\229\133\172\231\148\168' --[[Public/Common]])
                                :WaitForChild('\231\165\157\231\166\143' --[[Blessing]])
                                :WaitForChild('\231\165\157\231\166\143' --[[Blessing]])
                                :FireServer(unpack(args))
                            end
                        else
    ...
    local function useskill_ticket()
        if canstartticket then
            ...
            game:GetService('ReplicatedStorage')
                :FindFirstChild('\228\186\139\228\187\182' --[[Event]])
                :FindFirstChild('\229\133\172\231\148\168' --[[Public/Common]])
                :FindFirstChild('\229\149\134\229\186\151' --[[Shop]])
    ...
    local function toggleGuildUI(state)
        pcall(function()
            game:GetService('Players').LocalPlayer.PlayerGui.GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\229\133\172\228\188\154' --[[Guild]]].Visible =
                state
        end)
    end
    ...
    local function herbLoop()
        while herbController.enabled do
            ...
            then
                pcall(function()
                    game:GetService('ReplicatedStorage')['\228\186\139\228\187\182' --[[Event]]]['\229\174\162\230\136\183\231\171\175']['\229\174\162\230\136\183\231\171\175UI']['\230\137\147\229\188\128\229\133\172\228\188\154']
                        :Fire()
                    task.wait(0.5)
                    game:GetService('ReplicatedStorage')['\228\186\139\228\187\182' --[[Event]]]['\229\133\172\231\148\168' --[[Public/Common]]]['\229\133\172\228\188\154' --[[Guild]]]['\229\136\183\230\150\176\229\133\172\228\188\154\229\149\134\229\186\151']
                        :FireServer()
                end)
                task.wait(1.5)
            else
...
features6:AddButton('每月鑰匙購買', function()
    ...
    local remote = Rep:FindFirstChild("\228\186\139\228\187\182" --[[Event]])
        :FindFirstChild("\229\133\172\231\148\168" --[[Public/Common]])
    ...
    local FARM_UPGRADE_EVENT = REPLICATED_STORAGE
        :WaitForChild('\228\186\139\228\187\182' --[[Event]])
        :WaitForChild('\229\133\172\231\148\168' --[[Public/Common]])
        :WaitForChild('\229\134\156\231\148\176' --[[Farmland]])
    ...
    local function GetLevel(path)
        ...
        for _ = 1, RETRY_COUNT do
            local success, result = pcall(function()
                return game:GetService('Players').LocalPlayer.PlayerGui.GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]][path]['\232\131\140\230\153\175' --[[Background]]]['\229\177\158\230\128\167\229\140\186\229\159\159']['\229\177\158\230\128\167\229\136\151\232\161\168']['\229\136\151\232\161\168']['\231\173\137\231\186\167']['\229\128\188' --[[Value]]]
            end)
    ...
    local function UpdateFarmLevel()
        spawn(function()
            ...
            local newLevel = GetLevel('\229\134\156\231\148\176' --[[Farmland]])
            ...
            if isWorkingFarm then
                ...
                pcall(function()
                    for farmIndex = 1, 5 do
                        ...
                        -- 獲取當前等級
                        local currentLevel =
                            GetLevel('\229\134\156\231\148\176' --[[Farmland]])
                        ...
                        -- 最終確認
                        local finalLevel = GetLevel('\229\134\156\231\148\176' --[[Farmland]])
                        Farm_choose.Text = string.format(
                            '  ✅ 農田%d完成 %d級 (實際+%d級)',
                            farmIndex,
                            finalLevel,
    ...
    local Elixir_selection = features8:AddDropdown(
        ...
        function(text)
            ...
            pcall(function()
                game:GetService('ReplicatedStorage')['\228\186\139\228\187\182' --[[Event]]]['\229\174\162\230\136\183\231\171\175']['\229\174\162\230\136\183\231\171\175UI']['\230\137\147\229\188\128\231\130\188\228\184\185\231\130\137']
                    :Fire()
                wait(UI_LOAD_DELAY * 2)
            end)
            UpdateElixirLevel()
    ...
    pcall(function()
        farm5Level = tonumber(
            GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\229\134\156\231\148\176' --[[Farmland]]]['\232\131\140\230\153\175' --[[Background]]]['\229\177\158\230\128\167\229\140\186\229\159\159']['\229\177\158\230\128\167\229\136\151\232\161\168']['\229\136\151\232\161\168']['\231\173\137\231\186\167']['\229\128\188' --[[Value]]].Text:match(
                '%d+'
            )
        ) or 0
    end)
    GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\229\134\156\231\148\176' --[[Farmland]]].Visible =
        false

    -- 获取炼丹炉等级
    pcall(function()
        local elixirUI = ReplicatedStorage
            :FindFirstChild('\228\186\139\228\187\182' --[[Event]], true)
        ...
        if elixirUI then
            ...
            elixirLevel = tonumber(
                GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\231\130\188\228\184\185\231\130\137']['\232\131\140\230\153\175' --[[Background]]]['\229\177\158\230\128\167\229\140\186\229\159\159']['\229\177\158\230\128\167\229\136\151\232\161\168']['\229\136\151\232\161\168']['\231\173\137\231\186\167']['\229\128\188' --[[Value]]].Text:match(
                    '%d+'
                )
            ) or 0
        end
        GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\231\130\188\228\184\185\231\130\137'].Visible =
            false
    end)
    ...
    local arenaShopEnabled = false -- Set to true to enable Arena Shop auto-buy

    -- -- Auto Buy Soul from Arena Shop
    local function arenaShop()
        -- Check Stock
        local stock = LocalPlayer.PlayerGui.GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\231\171\158\230\138\128\229\156\186' --[[Arena]]]['\232\131\140\230\153\175' --[[Background]]]['\229\143\179\228\190\167\231\149\140\233\157\162']['\229\149\134\229\186\151' --[[Shop]]]['\229\136\151\232\161\168']:GetChildren()[12]['\230\140\137\233\146\174']['\229\186\147\229\173\152']
        local arenaCurrency = LocalPlayer.PlayerGui.GUI['\228\184\187\231\149\140\233\157\162']['\228\184\187\229\159\142']['\232\180\167\229\184\129\229\140\186\229\159\159']['\231\180\171\233\146\187']['\230\140\137\233\146\174']['\229\128\188' --[[Value]]].text
        -- stock text will return "6 left"
        if stock and stock.Text then
            local stockLeft = tonumber(stock.Text:match('(%d+)'))
            if stockLeft and stockLeft > 0 and tonumber(arenaCurrency) >= 500 then
                -- Fire RemoteEvent to buy item
                local remote = ReplicatedStorage
                    :WaitForChild('\228\186\139\228\187\182' --[[Event]])
                    :WaitForChild('\229\133\172\231\148\168' --[[Public/Common]])
                    :WaitForChild('\231\171\158\230\138\128\229\156\186' --[[Arena]])
                    :WaitForChild('\232\180\173\228\185\176')
                if remote then
                    remote:FireServer(11) -- Assuming '11' is the item ID for Arena Shop item
                    print('Arena Shop item purchased successfully!')

                    arenaCurrency = arenaCurrency - 500
                else
                    warn('RemoteEvent for Arena Shop purchase not found!')
                end
            else
                arenaShopEnabled = false
                print('Arena Shop item is out of stock.')
            end
        else
            warn('Could not retrieve stock information from GUI.')
        end
    end

    if arenaShopEnabled then
        arenaShop()
    end
    ...
    local function CheckAndFire()
        ...
        local gui =
            LocalPlayer.PlayerGui.GUI['\228\186\140\231\186\167\231\149\140\233\157\162' --[[Secondary Interface]]]['\232\135\170\229\138\168\229\135\186\229\148\174\229\188\185\229\135\186\230\161\134']['\232\131\140\230\153\175' --[[Background]]]['\230\140\137\233\146\174']['\230\147\141\228\189\156\229\140\186\229\159\159']['\229\130\168\229\173\152']['\229\155\190\230\160\135']['\229\155\190\230\160\135']
