...
toggleImg.Size = UDim2.new(0, 25, 0, 25)
...
mainFrame.Size = UDim2.new(0, 150, 0, 155) -- Mulai dari ukuran 0 (tertutup)
...
toggleImg.MouseButton1Click:Connect(function()
	...
	local targetSize = isOpen and UDim2.new(0, 175, 0, 155) or UDim2.new(0, 175, 0, 0)
...
createToggle("Auto Teleport", 0.84, function(state)
	isTPHookRunning = state
